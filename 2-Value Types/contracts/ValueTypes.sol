...
// 2-references- Reference types do not store the value directly. Instead, they store a reference to the data location, which means they point to where the actual data is stored
